...
public class soldierMob extends EntityGolem implements IRangedAttackMob
{
    public soldierMob(World par1World)
    {
        super(par1World);
...
//seperate class
/*@SideOnly(Side.CLIENT) class renderMobSoldier extends RenderLiving {
